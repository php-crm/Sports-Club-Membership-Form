...
if(ISSET($_POST))
{
  ...
  $field1="<b>Address: </b>"."<br>"."Street: ".$address."<br>"."City: ".$city."<br>"."State: ".$state."<br>"."Zip Code: ".$zip_code."<br>"."Country: ".$country."<br>"."<b>Date of Birth:</b> ".$dob."<br>"."<b>Sports Name:</b> ".$sport."<br>"."<b>Terms of Service:</b> ".$term_service;
}
else
{
echo "Thanks";	
